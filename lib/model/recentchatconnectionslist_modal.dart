...
class Connections {
  Connections(
    ...
    _email=email;
    _phone=phone;
    _transit_allowed=transit_allowed;
  ...
  Connections.fromJson(dynamic json) {
    ...
    _transit_allowed =json['transit_allowed'];
  }
  ...
  String get transit_allowed => _transit_allowed;
 ...
 map['transit_allowed']=_transit_allowed;
    return map;
  }
  ...
  set transit_allowed(String value){
    _transit_allowed =value;
  }
}
