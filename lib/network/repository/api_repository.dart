...
class ApiRepository {
  ...
  Future<Autogenerated> otpLogin(String mobile,
      String otp,String fcmToken) async {
    dynamic data = {
      "mobile": mobile,
      "otp": otp,
      "fcm_token": fcmToken
    ...
    var response = await _dio.post(
        StringConstant.BASE_URL + "otp-auth", data: data);
    if (response.statusCode == 200) {
      return Autogenerated.fromJson(response.data);
    } else {
      Helper.showMessage(response.statusMessage);
  ...
  Future<Autogenerated> loginOtp(String phoneno,
      ) async {
    dynamic data = {
      "mobile": phoneno,
    };
    var response = await _dio.post(StringConstant.BASE_URL + "sms/login-otp", data: data);
    if (response.statusCode == 200) {
      return Autogenerated.fromJson(response.data);
    } else {
      Helper.showMessage(response.statusMessage);
  ...
  Future<Autogenerated> userRegistration(String name, String phoneNo,
      String email,
      String password, String confirmpassword,otp) async {
    dynamic data = {
      "name": name,
      "email": email,
      "phone": phoneNo,
  ...
  Future<LoginModel> UpdateProfile_Api(String firstname, String phone,
    ...
    print("email id that we have to update " + email);
    _dio.options.headers["Authorization"] = "bearer  ${token}";
    dynamic data = {
      "password": password,
      "name": firstname,
    ...
    var response = await _dio.put(
        StringConstant.BASE_URL + "/User/update", data: data);
    if (response.statusCode == 200) {
      return LoginModel.fromJson(response.data);
    } else {
      Helper.showMessage(response.statusMessage);
  ...
  Future<Schudleclassmodal> schudleclass_Api(String token, String name,
      String description,
      String date, String time, image) async {
    ...
    var response = await _dio.post(StringConstant.BASE_URL + "live-class/create", data: formData);
  ...
  Future<dynamic> leavevideocall(String token, String id) async {
    ...
    var response = await _dio.get(
        StringConstant.BASE_URL + "meeting/leave/" + id);
    if (response.statusCode == 200) {
  ...
  Future<Meettoken> vidoecallstatus(String token, String meeting_id) async {
    _dio.options.headers["X-Auth-Token"] = "${token}";
    print("Metting id $meeting_id");
    var response = await _dio.get(
        StringConstant.BASE_URL + "meeting/status/" + meeting_id);
    if (response.statusCode == 200) {
  ...
  Future<RtmTokenModel> rtmtoken(String token, String id) async {
    _dio.options.headers["X-Auth-Token"] = "${token}";
    var response = await _dio.get(
        StringConstant.BASE_URL + "live-chatroom/token/" + id);
    if (response.statusCode == 200) {
  ...
  Future<SubCategoryModal> subCategory(String token,String id) async {
    _dio.options.headers["X-Auth-Token"] = "${token}";
    var response = await _dio.get( StringConstant.BASE_URL + "subcategories/${id}");
    if (response.statusCode == 200) {
  ...
  Future<CourseDetailModal> courseDetails(String token,String id) async {
    _dio.options.headers["X-Auth-Token"] = "${token}";
    var response = await _dio.get( StringConstant.BASE_URL + "course-detail/${id}");
    if (response.statusCode == 200) {
  ...
  Future<StudentLearningDetailsModal> studentLearningDetails(String token) async {
    _dio.options.headers["X-Auth-Token"] = "${token}";
    var response = await _dio.get( StringConstant.BASE_URL +"admin/course/mysubscription");
    if (response.statusCode == 200) {
  ...
  Future<FollowInstructorModal> followInstructor(String token,String id) async {
    print("DataToken $token");
    _dio.options.headers["X-Auth-Token"] = "${token}";
    print("Data $id");
  ...
  Future<Schudlemeet> createmeeting(String title, String subject,
      String date, String starttime,String endtime,var repeatable,var audio,var video, String token) async {
    _dio.options.headers["X-Auth-Token"] = "${token}";
    dynamic data = {
      "name": title,
    ...
    var response = await _dio.post(StringConstant.BASE_URL + "meeting/create",
        data: data);
    if (response.statusCode == 200) {
  ...
  Future<dynamic> watch_time(String token,user_id,video_id) async {
    ...
    var response = await _dio.post(StringConstant.BASE_URL + "watch-time/record",data:data);
    if (response.statusCode == 200) {
      return response.data;
    } else {
      Helper.showMessage(response.statusMessage);
  ...
  Future<ContactsmatchModal> searchusers(String search, String token) async {
    ...
    var response = await _dio.post(StringConstant.BASE_URL + "connection/search",data: data);
    if (response.statusCode == 200) {
  ...
  Future<LMSSearchModal> lmsSearch(String search, String token) async {
    ...
    var response = await _dio.post(StringConstant.BASE_URL + "search",
        data: data);
    if (response.statusCode == 200) {
  ...
  Future<dynamic> deleteMeeting(String token, String meetingId) async {
    ...
    var response = await _dio.get(StringConstant.BASE_URL + "meeting/delete/${meetingId}",);
    if (response.statusCode == 200) {
      return response.data;
    } else {
      Helper.showMessage(response.statusMessage);
  ...
  Future<dynamic> deleteBroadcast(String token,String broadcastId) async {
    _dio.options.headers["X-Auth-Token"] = "${token}";
    var response = await _dio.get(StringConstant.BASE_URL + "live-class/delete/${broadcastId}");
    if (response.statusCode == 200) {
      return response.data;
    } else {
      Helper.showMessage(response.statusMessage);
  ...
  Future<dynamic> progressLesson(String token,String lessonId) async {
    _dio.options.headers["X-Auth-Token"] = "${token}";
    var response = await _dio.get(StringConstant.BASE_URL + "progresslesson/${lessonId}");
    if (response.statusCode == 200) {
      return response.data;
    } else {
      Helper.showMessage(response.statusMessage);
  ...
  Future<Blockuserlist> blockuserist( String token) async {
    _dio.options.headers["X-Auth-Token"] = "${token}";
    var response = await _dio.get(StringConstant.BASE_URL + "connection/blocked-connections");
    if (response.statusCode == 200) {
  ...
  Future<Meettoken> hosttoken(String token, String id) async {
    _dio.options.headers["X-Auth-Token"] = "${token}";
    var response = await _dio.get(StringConstant.BASE_URL + "meeting/start/" + id);
    if (response.statusCode == 200) {
      return Meettoken.fromJson(response.data);
    } else {
      Helper.showMessage(response.statusMessage);
  ...
  Future<dynamic> deletegroupmember({String token,
    ...
    _dio.options.headers["X-Auth-Token"] = "$token";
    var response = await _dio.post( StringConstant.BASE_URL +"connection/"+endpoint,
        data: formData);
  ...
  Future<Meettoken> usertoken(String token, String meetid) async {
    _dio.options.headers["X-Auth-Token"] = "${token}";
    var response = await _dio.get(
        StringConstant.BASE_URL + "meeting/join/" + meetid);
    if (response.statusCode == 200) {
      return Meettoken.fromJson(response.data);
    } else {
  ...
  Future<InstructorDetailsModal> getInstructorDetails(String token,String id) async {
    print("grtcxvfffn  $id");
    _dio.options.headers["X-Auth-Token"] = "$token";
    var response = await _dio.get(
        StringConstant.BASE_URL + "instructor-detail/${id}");
  ...
  Future<MeetingScheduleModal> history(String token) async {
    _dio.options.headers["X-Auth-Token"] = "$token";
    var response = await _dio.get(
        StringConstant.BASE_URL + "meeting-history");
    if (response.statusCode == 200) {
      print("Response ${response.data}");
  ...
  Future<MeetingScheduleModal> historyBoardCast(String token) async {
    _dio.options.headers["X-Auth-Token"] = "$token";
    var response = await _dio.get(
        StringConstant.BASE_URL + "broadcast-history");
    if (response.statusCode == 200) {
      print("Response ${response.data}");
      return MeetingScheduleModal.fromJson(response.data);
    } else {
  ...
  Future<Autogenerated> fcmnotifiction(String message,var name,var token, image,callId,var type,fcmtoken,userprofile,datetime,userpeerid,senderpeerid,textid) async {
...
/*  Future<Autogenerated> fcmresponse(String message, var name, var token, image, callId, var type, fcmtoken) async {
  ...
  Future<UserProfileModal> getUserProfile(String token) async {
    ...
    _dio.options.headers["X-Auth-Token"] = "$token";
    var response = await _dio.get(
        StringConstant.BASE_URL + "profile");
  ...
  Future<InstructorProfileModal> getInstructorProfile(String token,String id) async {
    print("Sir Sorry $token");
    _dio.options.headers["X-Auth-Token"] = "$token";
    var response = await _dio.get(
        StringConstant.BASE_URL +"instructor/${id}");
  ...
  Future<InstructorCourseModal> getInstructorCourses(String token,String id) async {
    print("Sir Sorry $token");
    _dio.options.headers["X-Auth-Token"] = "$token";
    var response = await _dio.get(
        StringConstant.BASE_URL +"courses-by-instructor/${id}");
  ...
  Future<GetRequestClassList> getRequestClassList(String token) async {
    ...
    _dio.options.headers["X-Auth-Token"] = "$token";
    var response = await _dio.get(
        StringConstant.BASE_URL +"requestclasses");
  ...
  Future<dynamic> updateUserProfile({String token,
    String name,
    String email,
    String age,
    String phone,
    ...
    _dio.options.headers["X-Auth-Token"] = "$token";
    var response = await _dio.post(
        StringConstant.BASE_URL + "profile/update",data: data);
  ...
  Future<dynamic> requestPrivateClasses({String token,
    String instructorId,
    String topic,
    String description,
    String date,
    ...
    _dio.options.headers["X-Auth-Token"] = "$token";
    var response = await _dio.post(
        StringConstant.BASE_URL +"requestclass",
        data: data);
  ...
  Future<dynamic> courseFeedback({String token,
    String courseId,
    String rating,
    String comment
  }) async {
    ...
    _dio.options.headers["X-Auth-Token"] = "$token";
    var response = await _dio.post(
        StringConstant.BASE_URL +"feedback-course",
        data: data);
  ...
  Future<dynamic> sendReport({String token,
    String module,
    String message,
  }) async {
    dynamic data = {
    ...
    _dio.options.headers["X-Auth-Token"] = "$token";
    var response = await _dio.post(
        StringConstant.BASE_URL +"report",
        data: data);
  ...
  Future<dynamic> requestClassStatus({String token,
    String id,
    String reason
  }) async {
    dynamic data = {
    ...
    _dio.options.headers["X-Auth-Token"] = "$token";
    var response = await _dio.post(
        StringConstant.BASE_URL + "requestedclass-status",
        data: data);
