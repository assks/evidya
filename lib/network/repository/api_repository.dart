...
class ApiRepository {
  ...
  Future<Schudlemeet> createmeeting(
    ...
    var response = await _dio.post(StringConstant.BASE_URL + "meeting/create", data: data);
    if (response.statusCode == 200) {
  ...
  Future<LMSSearchModal> lmsSearch(String search, String token) async {
    _dio.options.headers["X-Auth-Token"] = "${token}";
    dynamic data = { "term": search };
    var response = await _dio.post(StringConstant.BASE_URL + "search", data: data);
    if (response.statusCode == 200) {
  ...
  Future<RTMUserNameFetchModal> rtmFetchUserName( String token, String iD, String name) async {
    _dio.options.headers["X-Auth-Token"] = "${token}";
    dynamic data = {"id": iD,"name": name};
    var response = await _dio.post(StringConstant.BASE_URL + "meeting-rtm-token", data: data);
    if (response.statusCode == 200) {
  ...
  Future<Autogenerated> fcmnotifiction(
      // ChatModel model,
      String message,
      var name,
      var token,
  ...
  Future<Autogenerated> fcmnotifictionChat(
      ChatModel model,
      // String message,
      var name,
      var token,
