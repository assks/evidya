            ...
            items:  <BottomNavigationBarItem>[
              BottomNavigationBarItem(
                icon: Container(
                  ...
                  child: Column(
                    children: [
                      Image.asset("assets/images/bottombar/bmeet.png",
                        color: _selectedIndex == 0 ?
                        AppColors.appNewDarkThemeColor
                            : Colors.white,
                        height: 4.h,width: 4.h,),
                      Text('bmeet',style: TextStyle(
                        fontSize: 7.sp,
              ...
              BottomNavigationBarItem(
                icon: Container(
                  ...
                  child: Column(
                    children: [
                      Image.asset("assets/images/bottombar/blive.png",
                        color: _selectedIndex == 1 ?
                        AppColors.appNewDarkThemeColor
                            : Colors.white,
                        height: 4.h,width: 4.h,),
                      Text('blive',style: TextStyle(
                          fontSize: 7.sp,
                          fontWeight: FontWeight.bold,
                          color: _selectedIndex == 1 ?
                          AppColors.appNewDarkThemeColor
              ...
              BottomNavigationBarItem(
                icon: Container(
                  ...
                  child: Column(
                    children: [
                      Image.asset("assets/images/bottombar/bchat.png",
                        color: _selectedIndex == 2 ?
                        AppColors.appNewDarkThemeColor
                            : Colors.white,
                        height: 4.h,width: 4.h,),
                      Text('bchat',style: TextStyle(
                          fontSize: 7.sp,
                          fontWeight: FontWeight.bold,
                          color: _selectedIndex == 2 ?
                          AppColors.appNewDarkThemeColor
              ...
              BottomNavigationBarItem(
                icon: Container(
                  ...
                  child: Column(
                    children: [
                      Image.asset("assets/images/bottombar/blearn.png",
                        color:_selectedIndex == 3 ?
                        AppColors.appNewDarkThemeColor
                            : Colors.white,
                        height: 4.h,
              ...
              BottomNavigationBarItem(
                icon: Container(
                  ...
                  child: Column(
                    children: [
                      Image.asset("assets/images/bottombar/Profile.png",
                        color: _selectedIndex == 4 ?
                        AppColors.appNewDarkThemeColor
                            : Colors.white,
