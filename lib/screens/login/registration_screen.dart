...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  void _registerUser() {
    ...
    Helper.checkConnectivity().then((value) =>
    {
      if (value)
        {
          ApiRepository().userRegistration(_nameController.text, _phonenoController.text, _emailController.text, _passwordController.text, _confirmPasswordController.text,_otpController.text).then((value) {
            if (value != null) {
