...
// Obtain shared preferences.
  ...
  void queryRowCount() async {
    ...
    userpeerid = value;
    // print('userpeer Id:$userpeerid');
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString('action', userpeerid);
                                                                          ...
                                                                          Container(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              if (chatModel.type == "video" || chatModel.type == "doc")
                                                                                progressbar(log.length, log[i], i),
                                                                                ...
                                                                                children: [
                                                                                  ConstrainedBox(
                                                                                    ...
                                                                                    child: ClipRRect(
                                                                                      ...
                                                                                      child: Image.file(File(chatModel.url),
                                                                                          fit: BoxFit.cover,
                                                                                          errorBuilder: (context, url, error) => const Icon(
                                                                                                Icons.error,
                                                                                                size: 70,
  ...
  Future<void> getImage(ImageSource source) async {
    ...
    if (replytex != "") {
      model.replyText = replytex;
      model.reply = 'reply';
    }
    imageapi(pickedFile, pickedFile.name, widget.rtmpeerid, model);
  ...
  _pickpdf() async {
    ...
    imageapi(file, files.name, widget.rtmpeerid, model);
    // await _insert(model);
    // widget.logController.addLog(model);
    // if (replytex != "") {
    //   var file = replytex +
  ...
  void _sendPeerMessage() async {
    ...
    try {
      ...
      fcmapicall(model, widget.recentchatuserdetails.fcm_token, '',
          userpeerid.toString(), 'basic_channel', '', textid);
  ...
  Widget images() {
    return afile
        ? SizedBox(
            ...
            child: Image.file(File(replyImagePath),
  ...
  void fcmapicall2(String msg, String fcmtoken, image, String call_id,
          ...
          if (value)
            {
              ApiRepository()
                  .fcmnotifiction(
                      ...
                      DateTime.now().toString(),
                      userpeerid,
                      widget.recentchatuserdetails.peerId,
                      textid)
                  .then((value) async {})
            }
          else
  ...
  void fcmapicall(ChatModel msg, String fcmtoken, image, String call_id,
      String type, String profileimage, String textid) {
    Helper.checkConnectivity().then((value) => {
          if (value)
            {
  ...
  void localdata() async {
    ...
    PreferenceConnector.getJsonToSharedPreferenceefcmtoken(
  ...
  void rtmforwordmessage(ChatModel oldModel, Connections joiner) async {
    ...
    if (oldModel.type == 'image' &&
      ...
      imageapi(path, oldModel.message, joiner.peerId, model);
      updatelocaldata(widget.rtmpeerid);
  ...
  doubletick(String status, id, logindex) {
    ...
    if ((Chat_Screen.onlinestatus == "Online") || status == "delivered") {
      ...
      if (id != "" /*|| id !="Instance of 'Future<dynamic>'"*/) {
        var val = dbHelper.updatedeliverystatus(int.parse(id), "delivered");
