...
class _RecentChatState extends State<RecentChat> {
                    ...
                    onTap: () {
                      Navigator.of(context)
                          .push(MaterialPageRoute(
                              builder: (context) => Contactsearch_screen()))
        ...
        return Expanded(
            child: ListView.separated(
                ...
                separatorBuilder: (_, __) => const Divider(
                    thickness: .5, height: 1, color: Colors.black26),
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              CircleAvatar(
                                ...
                                child: Center(
                                  child: filterdUsers[i].profile_image == ""
                                      ? Text(
                                                ...
                                                ? Text(
                                                    day == 0
                                                        ...
                                                        : day == 1
                                                            ? 'Yesterday'
                                                            : DateFormat('yy/MM/dd')
                                                                .format(DateTime.parse(filterdUsers[i].timeStamp == null
                                                                    ? "2022-07-25 17:36:30.956695"
                                                                    : filterdUsers[i]
                                                                        .timeStamp
                                                                        .toString()))
  ...
  _insert(Connections users) async {
    ...
    Map<String, dynamic> row = {
      ...
      DatabaseHelper.blockstatus: users.status,
    ...
    final blockstatus =
        await dbHelper.updatedstatus(users.peerId, users.status);
    if (blockstatus != users.status) {
      final id = await dbHelper.updatestatus(users.peerId, users.status);
      print('inserted row id1: $id');
      _query();
    }
