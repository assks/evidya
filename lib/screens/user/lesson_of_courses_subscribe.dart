...
class LessonOfCourseSubscribe extends StatefulWidget {
  ...
  const LessonOfCourseSubscribe({this.courseId,this.courseName, Key key}) : super(key: key);

  @override
  State<LessonOfCourseSubscribe> createState() => _LessonOfCourseSubscribeState();
}
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: Container(
              height: 100.h,
              margin: EdgeInsets.only(left: 1.h,right: 1.h,top: 1.h,bottom: 1.h),
                     ...
                     child: Padding(
                       ...
                       child: Row(
                         ...
                         style: TextStyle(fontSize: 14.sp,
                          ...
                          : Text("${lessonList.length} Lessons",
                             style: TextStyle(fontSize: 14.sp,
                                 color: Colors.black54,
                                 fontWeight: FontWeight.bold),),
                         ],
                               ...
                               child: Column(
                                 children: [
                                               ...
                                               child: ClipRRect(
                                                 ...
                                                 child: loader == false
                                                   ...
                                                   child: SizedBox(height: 20,width: 20,
                                                     ...
                                                     : Image.network(
                                                   StringConstant.IMAGE_URL+ lessonList[index].image,
                                                   height: 7.h,
                                                   width: 15.w,
                                                   fit: BoxFit.fill,
                                                 ),
                                   ...
                                   Row(
                                     ...
                                     children: [
                                       loader == false? Text("")
                                       :Text("Duration: ${lessonList[index].duration} min",
                                         style: TextStyle(fontSize: 10.sp,
                                           color: Colors.grey,
                                       ...
                                       Row(
                                         ...
                                         children: [
                                           ...
                                           SizedBox(width: 10,),
                                           Text("Continue watching",style: TextStyle(fontSize: 8.sp,
                                               fontWeight: FontWeight.w600),),
                                           SizedBox(width: 10,),
                                           Container(
                           ...
                           onTap: (){
                             Navigator.of(context).push(MaterialPageRoute(
                                 builder: (context) => LandscapePlayer(
                                   ...
                                   vidoeid:lessonList[index].videoId.toString(),
      ...
      if (value)
        {
              ...
              .then((value) =>
          {
            if (value != null)
              {
                ApiRepository().lesson(value,courseId.toString()).then((value) {
                  if (value != null) {
                    setState(() {
